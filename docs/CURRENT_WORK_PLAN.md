...
earliest action anchor and distinct wall-service tick, consumes creation in the
...
Both are accepted. Three-instance review limit is reached; another fresh review
requires human direction before maintainers decide ADR-0047. No benign runnable
...
local gates. Human-directed independent review and maintainer disposition of ADR-0047 precede
runnable changes.
