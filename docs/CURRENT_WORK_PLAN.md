...
Next work item: maintainer review of PR #371 and disposition of Proposed ADR-0047;
do not begin runnable work before that decision.
...
finding is corrected in the documentation follow-up. ADR-0047 remains Proposed.
...
its sole P3 status-wording finding is corrected. Maintainers must still decide
...
| C5b18 | Freeze the passive teardown-obligation successor | Causal-clock correction, local gates and CI `PASSED`; independent review 2 **Ready with non-blocking follow-ups** at `a985707` | Reviewer found no code defect; sole P3 stale wording corrected in docs-only follow-up. PR #371 is ready for maintainer review; disposition of Proposed ADR-0047 remains. No runnable fixture, process or guest is authorized. |
