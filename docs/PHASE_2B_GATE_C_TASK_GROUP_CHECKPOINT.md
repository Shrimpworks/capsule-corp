...
runtime/libkrun substream is `IN_PROGRESS — TRENDING_BAD` after v20-v22 refused before readiness;
v22 localized the stop to inherited-root SHA-256 while host-only hashing matches, and v23 hash-
diagnostic materialization passed without execution. This
