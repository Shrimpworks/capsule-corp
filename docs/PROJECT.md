...
registration-state transitions. The unwired implementation now verifies 62 TypeScript raw/schema
proposal targets and 121 Go targets: 81 internal-CBOR/wrapper cases plus all 40 registration-state
cases. Semantic planning, Swift, consumers, and endpoints remain pending. See the
