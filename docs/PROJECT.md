...
now binds its contract/profile/plan/frame identities, but all executable successor identities
remain null; fresh executable construction, controlled C5b transport execution, installed
composition, and admission remain `BLOCKED`.
