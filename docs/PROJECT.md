...
v1 is also `PASSED` only for exact generated byte/state/restoration conformance; controlled C5b
transport execution, installed composition, and admission remain `BLOCKED`.
