...
**Open production work.** The current owner/coordinator is injected in process, not a macOS
multi-process lock. Production archive/compaction, backup and rollback handling, power-loss tests,
