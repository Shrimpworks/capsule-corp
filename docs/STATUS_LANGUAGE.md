...
| Archive F6 and product admission | `IN_PROGRESS — TRENDING_GOOD` | F6 production-engine selection, installed storage/owner composition, real APFS/power-loss and restore-activation evidence, retention/deletion policy, and every product consumer remain `BLOCKED`. F5 advances none of those claims. |
