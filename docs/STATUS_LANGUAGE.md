...
| Typed guest transport research and C5b0/C5b1/C5b2 construction | `PASSED` | The passive R2/C5a design and immutable [C5b0 packet](https://github.com/Shrimpworks/capsule-experiments/tree/b357d0c0fb29100c180494e67cebd7809aabe3c5/experiments/typed-guest-transport-c5b0-v19-successor) freeze the role contracts and typed frames. The [C5b1 archive](https://github.com/Shrimpworks/capsule-experiments/tree/db08ebf277432e06d6cba3b7f7338e3bd4a61252/experiments/typed-guest-transport-c5b1-executable-successor) retains reproducible runner/root/init/launcher/hard-stop-controller candidates, and the [C5b2 archive](https://github.com/Shrimpworks/capsule-experiments/tree/5a2f835e8c9df8279237f940f5af757e119593bd/experiments/typed-guest-transport-c5b2-governed-input-closure) independently binds the available current-source libkrun/header/ABI/final-runner bytes. The governed `deno_core` and libkrunfw bytes, real controller, composite, controlled execution, installed composition, and admission remain `BLOCKED`; separate firmware is inapplicable under ADR-0041. |
