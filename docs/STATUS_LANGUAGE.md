...
| Installed owner-lock G3/I2B | `BLOCKED` | Proposed ADR-0038 selects the bootstrap owner and signed-record/store-open contract. Resume with I2B1 passive object fixtures, then separately authorized exact Team-3DDR profiles and the installed handoff/container/descriptor-relative fault corpus. |
