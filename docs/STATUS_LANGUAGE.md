...
| Archive F2 fixed-store v2 migration/full verifier | `PASSED` | The exact owner-asserted local fixed-store migration, downgrade refusal, empty-archive full verifier, missing-lifecycle preservation, and fault/corruption/capacity oracles pass. F3+ archive behavior and production admission remain outside this scope. |
