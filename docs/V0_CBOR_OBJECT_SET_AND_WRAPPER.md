...
| `ExecutionPlan` v0 | Future daemon producer; future Supervisor/Broker consumers; current passive authority-plane and registration tests decode it | CBOR up to 65,536 bytes; depth 8; 256 items; map 64; array 8. Ordinary fixture 527 bytes / `ef268a0b829adc1ce1307203f4b805f63379954ccf41e8e20a7487b6e5acf241` | **PASSIVE AUTHORITY-PLANE FIXTURE / EXCLUDED FROM ACTIVATION.** The exact single-`main.mjs` plan is retained, but no endpoint or execution consumer is admitted. |
| `PlanRegistration` v0 | Future Supervisor producer; future daemon/Broker consumers; current passive authority-plane and registration tests emit and decode it | CBOR up to 4,096 bytes; depth 4; 33 items; map 16; arrays forbidden. Ordinary fixture 165 bytes / `82f9e72dcb8b0f6e16990c2e09aad4ac8661e72ff72820edf1b57ef5f9537199` | **PASSIVE AUTHORITY-PLANE FIXTURE / EXCLUDED FROM ACTIVATION.** It binds the exact plan in the unwired facade and is not independently signed portable authority. |
