...
- passive field-authority verification for 228 fields across 20 selected pre-freeze targets,
...
5. **Next Source Validator path:** accepted ADR-0034's M1 bytes and Proposed ADR-0035's passive V0
   frames are retained. V1 must next construct and review the exact hermetic parser artifact; V2-V5
