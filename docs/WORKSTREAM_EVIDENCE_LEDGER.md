...
| C5b2 governed-input closure | `PASSED` at [`capsule-experiments` merge `5a2f835e8c9df8279237f940f5af757e119593bd`](https://github.com/Shrimpworks/capsule-experiments/tree/5a2f835e8c9df8279237f940f5af757e119593bd/experiments/typed-guest-transport-c5b2-governed-input-closure): the exact current-source libkrun header, ABI audit, unsigned dylib, and final runner source/binary are independently bound by bytes, Mach-O metadata, dependency/export/import closure, and C17 audit. | The governed `deno_core` and libkrunfw bytes remain absent; retained kernel/libkrunfw receipts are identity evidence only; separate firmware is inapplicable under ADR-0041; the real controller, composite, execution, and admission remain `BLOCKED`. Nothing was loaded or executed. |
| C3b exact-profile and App Group preflights | The zero-effect missing-profile stop is retained at merge `50c494d4841c5d42e8e2120b82c0481a706a5236`; the exact legacy profile was later restored outside Git. The portal observation is retained at merge `e6390253a274e9ead76366f9869a5e1b272a1595`, and its canonical correction at [`3671a6eb23357ff28de4562dd60e8f68173034ae`](https://github.com/Shrimpworks/capsule-experiments/tree/3671a6eb23357ff28de4562dd60e8f68173034ae/experiments/macos-installation-i2b3-supervisor-authority-epoch-e1-app-group-preflight) makes only Developer-portal registration of the frozen macOS-style App Group `NO_GO`. The profile/signature-only gate is `PASSED` at [`ee00ae2abbce64ae6458b82d0b53d904ee39aeb6`](https://github.com/Shrimpworks/capsule-experiments/tree/ee00ae2abbce64ae6458b82d0b53d904ee39aeb6/experiments/macos-installation-i2b3-supervisor-authority-epoch-e1-signed-profile-preflight): two explicit App IDs/profiles and exact current Supervisor, never-launched Coordinator, and legacy probe signature/entitlement identities were read back on the named owner Mac. | No App Group portal resource, bundle launch, container, sentinel, service, Keychain item, LocalAuthentication prompt, root/store, runtime, backend, VM, or guest was accessed. E1 execution remains `BLOCKED` on fresh exact authorization; ADR-0045 remains Proposed. |
...
The C3b profile/signature-only gate and C5b2's scoped governed-input closure are now complete. The
next exact gates are a freshly authorized C3b container matrix, a separate C6b1d authorization
packet, and credential-free construction of C5b's missing governed runtime/libkrunfw bytes plus the
real controller and immutable composite. C2b native execution, the C3b matrix, C5b controlled
execution, C6b1d live signing, installed composition, and admission remain `BLOCKED`.
