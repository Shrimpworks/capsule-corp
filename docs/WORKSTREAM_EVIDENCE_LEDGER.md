...
The C3b profile/signature-only gate is now complete. The next exact gates are a freshly authorized
C3b container matrix and a separate C6b1d authorization packet. C2b native execution, the C3b
matrix, C5b
