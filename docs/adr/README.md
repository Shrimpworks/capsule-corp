...
- [ADR-0047: Prepare an attempt-bound teardown obligation before launch](0047-prepare-teardown-obligation-before-launch.md)
  — Proposed; C5b18 review-1 findings are corrected and full local verification `PASSED`,
  review 2 is `IN_PROGRESS — TRENDING_GOOD`, and runnable/installed/guest/product work remains `BLOCKED`
